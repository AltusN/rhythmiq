...
class TestDistrictCreate:
    ...
    def test_district_create_name_too_short(self):
    ...
    def test_district_create_abbreviation_required(self):
        with pytest.raises(ValidationError):
...
class TestDistrictUpdate:
    ...
    def test_district_update_partial_abbreviation_only(self):
        d = DistrictUpdate.model_validate({"abbreviation": "GP"})
        assert d.name is None
        assert d.abbreviation == "GP"

    def test_district_update_valid(self):
    ...
    def test_district_update_name_too_short(self):
        with pytest.raises(ValidationError):
            DistrictUpdate.model_validate({"name": "A", "abbreviation": "GP"})

    def test_district_update_abbreviation_too_short(self):
        with pytest.raises(ValidationError):
